...
$yform->setValueField('html', array('', '</div><div class="col-sm-2">'));
$yform->setValueField('text', array('street_number', 'Nr. *'));
$yform->setValueField('html', array('', '</div><div class="col-sm-2">'));
...
$yform->setValueField('html', array('', '<div class="row form-row"><div class="col-sm-4">'));
$yform->setValueField('text', array('invoice_street', 'Strasse *'));
$yform->setValueField('html', array('', '</div><div class="col-sm-2">'));
$yform->setValueField('text', array('invoice_street_number', 'Nummer *'));
$yform->setValueField('html', array('', '</div><div class="col-sm-2">'));
...
$yform->setValidateField('empty', array('street', 'Bitte Straße eintragen'));
$yform->setValidateField('empty', array('street_number', 'Bitte Straßennummer eintragen'));
...
if (rex_request('invoice_address', 'string', '') != '1') {
    ...
    $yform->setValidateField('empty', array('invoice_street_number', 'Bitte Straßennummer des Rechnungsempfängers eintragen'));
