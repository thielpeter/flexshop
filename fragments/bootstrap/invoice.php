...
<div style="padding-top:165px; padding-left:38px; padding-right:38px">
	...
	<table style="width:100%;">
		...
		<tr>
			...
			<td style="text-align:right">
				<span><?php echo format_chf($this->getVar('sum')) ?></span>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td style="text-align:right" class="color-primary">
				<strong><?php echo format_chf($this->getVar('total')) ?></strong>
			</td>
		</tr>
		</tfoot>
	</table>
	...
	<p>Ich wünsche Ihnen viel Freude damit und bitte um Ausgleich der Rechnung innerhalb von 10 Tagen.<br/>Ich bin Ihnen dankbar, wenn Sie die Überweisung via Bank- oder Post-Konto tätigen. Sie helfen mir damit, Gebühren zu sparen, welche bei Einzahlung am Postschalter entstehen.</p>
