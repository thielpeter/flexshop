 ...
 * @author Peter Thiel
 *
 * @package redaxo\flexshop
 */

class rex_flexshop_settings
{
    /**
     * @return rex_addon
     */
...
//    }
    ...
    public static function install()
    {
        ...
        if (!$addon->hasConfig('redirect_article')) {
            $addon->setConfig('redirect_article', '');
            $addon->setConfig('cart_article', '');
        }
    }
}
